...
bool DecomposeTransform(const glm::mat4& transform, glm::vec3& translation, glm::quat& rotation, glm::vec3& scale)
{
	...
	NEXUS_ASSERT(epsilonEqual(LocalMatrix[3][3], static_cast<T>(1), static_cast<T>(0.00001)), "Matrix Decomposition error");
	...
	NEXUS_ASSERT(dot(Row[0], Pdum3) >= static_cast<T>(0), "Matrix Decomposition error");
#endif
